...
enum CompileCommand : string {
	dc = "cc/bin/powernex-dmd -m64 -dip25 -de -color=on -fPIC -debug -c -g -IKernel/src -JKernel/src -defaultlib= -debuglib= -version=bare_metal -debug=allocations -of$out $in",
	dc_header = "cc/bin/powernex-dmd -m64 -dip25 -de -color=on -fPIC -debug -c -g -IKernel/src -JKernel/src -defaultlib= -debuglib= -version=bare_metal -debug=allocations -o- -Hf$out $in",
	...
	user_dc = "cc/bin/powernex-dmd -m64 -dip25 -de -color=on -debug -c -g -IUserspace/libRT/src -IUserspace/libPowerNex/src -defaultlib= -debuglib= -version=bare_metal -debug=allocations -of$out $in",
...
static:
	...
	enum libpowernex = Target("Userspace/lib/libPowerNex.a", CompileCommand.user_ar, [UserspaceLibrary.libpowernex_obj], [UserspaceLibrary.syscall]);
}
