...
///
ref COM com2() @trusted {
	return comPorts[1];
}

///
ref COM com3() @trusted {
	return comPorts[2];
}

///
ref COM com4() @trusted {
	return comPorts[3];
}
...
private:
	static void _handleIRQ3(from!"data.register".Registers*) {
		_handleIRQ!com2();
		_handleIRQ!com4();
	}

	static void _handleIRQ4(from!"data.register".Registers*) {
		_handleIRQ!com1();
		_handleIRQ!com3();
	}
